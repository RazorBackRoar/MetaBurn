...
RazorBackRoar takes security seriously. This policy applies to **MetaBurn** and matches the organization-wide standard used across RazorBackRoar product repositories.
...
1. **GitHub Private Vulnerability Reporting** — use [Report a vulnerability](https://github.com/RazorBackRoar/MetaBurn/security/advisories/new) on this repository when enabled.
2. **Maintainer contact** — email the maintainer using the address on their [GitHub profile](https://github.com/RazorBackRoar) with a clear subject such as `SECURITY: MetaBurn`.
...
Please use [GitHub Issues](https://github.com/RazorBackRoar/MetaBurn/issues) for ordinary bugs and feature requests.
